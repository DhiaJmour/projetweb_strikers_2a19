...
class mailingc {
    ...
    function ajouteremail($mailing) 
        ...
        $sql="insert into repense (id,sujet,reponse,email) values (:id,:sujet,:reponse,:email) 
    ...
    {
        $sql="DELETE FROM repense where id= :id ";
        $db = config::getConnexion();
        $req=$db->prepare($sql);
    ...
    function recuperer($idemail)
    {
        ...
        $sql="SELECT * from repense where idemail=idemail";
