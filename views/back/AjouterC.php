...
{  
	$req="insert INTO categorie(marketName,marketLogo) values ('".$_POST['marketName']."','".$_POST['marketLogo']."')";
...
<input type="text" class="form-control" name="marketName" placeholder="Saisir le nom" value="" style="width:500px"> </br>
