<?php
include_once("C:\Users\Youssef\Music\Nouveau dossier\htdocs\youss\config.php");
include_once("C:\Users\Youssef\Music\Nouveau dossier\htdocs\youss\Model\livraison.php");
class livraisonC
{
    ...
    function afficherLivraisonTri(string $selon){
        $sql="select * from livraison order by ".$selon."";
